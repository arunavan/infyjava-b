...
class Demo
{
	public static void main(String[] args) {
		...
		/*
		 * Employee e1=new Employee(1,"Raj",98999,"SE"); Employee e2=new
		 * Employee(2,"Kiran",98999,"Analyst"); TreeSet eset=new TreeSet(new
		 * Namecomparator()); eset.add(e1); eset.add(e2); System.out.println(eset);
		 */
	}
